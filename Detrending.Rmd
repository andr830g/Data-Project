...
plot(prices$spot_price_dkk, col=alpha("black", 0.5), type="l")
...
plot(subset_prices$t, subset_prices$spot_price_dkk, col=alpha("black", 0.5), type="l")
...
plot(prices$t, prices$spot_price_dkk, type='l')
lines(prices$t, prices_trend, col='red', lwd=2)

plot(prices$t, prices$spot_price_dkk - prices_trend, type='l')
```
