...
prices["Sun"] <- ifelse(prices$Wday=="Søn", 1, 0)
prices["Sat"] <- ifelse(prices$Wday=="Lør", 1, 0)
prices["Fri"] <- ifelse(prices$Wday=="Fre", 1, 0)
prices["Thu"] <- ifelse(prices$Wday=="Tor", 1, 0)
prices["Wed"] <- ifelse(prices$Wday=="Ons", 1, 0)
prices["Tue"] <- ifelse(prices$Wday=="Tir", 1, 0)
prices["Mon"] <- ifelse(prices$Wday=="Man", 1, 0)
