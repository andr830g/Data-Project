...
We then created the function below to generate the day-ahead forecasts using different auto-regressive models such as the ARIMA/SARIMA.
...
## ARIMA(24, 1, 1)(7, 0, 1)(24) + weekend + wind + fossile + biomass + waste + exchange
### Day-ahead forecast on 28 days of test data
```{r}
...
### Day-ahead forecast on 59 days of test data
```{r}
